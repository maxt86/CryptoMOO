...
def main(argv=()):
    cmoo = cryptomoo.CryptoMOO()
    
    cmoo.set_mode(cryptomoo.Mode.CBC)
    
    cmoo.set_key(bytes.fromhex('140b41b22a29beb4061bda66b6747e14'))
    ...
    print(cmoo.decrypt(data[16:], data[:16]))
    ...
    cmoo.set_key(bytes.fromhex('36f18357be4dbd77f050515c73fcf9f2'))
